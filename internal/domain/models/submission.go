...
type Submission struct {
	...
	UserID         uint       `json:"user_id" gorm:"not null;uniqueIndex:idx_submission_assignment_user"`
	...
	WorkflowState  string     `json:"workflow_state" gorm:"not null;default:'unsubmitted'"`
