      ...
      {showCreate && (
        <form onSubmit={handleCreate} className="bg-white rounded-lg shadow p-6 mb-6 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              <label htmlFor="quiz-type" className="block text-sm font-medium text-gray-700 mb-1">Type</label>
              <select
                id="quiz-type"
            ...
            <div>
              <label htmlFor="quiz-points" className="block text-sm font-medium text-gray-700 mb-1">Points</label>
              <input
                id="quiz-points"
                type="number"
                min="0"
            ...
            <div>
              <label htmlFor="quiz-time-limit" className="block text-sm font-medium text-gray-700 mb-1">Time Limit (min)</label>
              <input
                id="quiz-time-limit"
                type="number"
                min="0"
                ...
                <div key={quiz.id} className="flex items-center justify-between p-4 hover:bg-gray-50">
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      <span className="font-medium text-gray-900 truncate block">{quiz.title}</span>
                  ...
                  <div className="flex items-center space-x-3 flex-shrink-0 ml-4">
                    ...
                    {!isTeacher && mySub && (
                      <>
                        ...
                        {mySub.attempt > 1 && (
                          <span className="text-xs text-gray-400">Attempt {mySub.attempt}</span>
                        )}
