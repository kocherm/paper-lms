        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <form onSubmit={handleCreate} className="flex gap-4 items-end">
            <div className="flex-1">
              ...
              <input name="name" required className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm" placeholder="Introduction to Mathematics" />
            </div>
            <div className="w-40">
              <label className="block text-sm font-medium text-gray-700 mb-1">Course Code</label>
              <input name="course_code" required className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm" placeholder="MATH101" />
            </div>
