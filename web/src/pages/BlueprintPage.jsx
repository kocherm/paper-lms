    ...
    return (
      <Layout>
        <div className="flex items-center justify-center py-20">
          ...
          <span className="ml-3 text-gray-500">Loading blueprint settings...</span>
        </div>
      </Layout>
    );
  }
    ...
    <Layout>
      ...
      {activeTab === 'associations' && (
        <div>
          ...
          <div className="bg-white rounded-lg shadow p-6 mb-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Add Associated Course</h3>
          ...
          <div className="bg-white rounded-lg shadow overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
              <h3 className="text-lg font-semibold text-gray-900">Associated Courses</h3>
              <button
            ...
            {associations.length === 0 ? (
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-1">No Associated Courses</h3>
      ...
      {activeTab === 'sync' && (
        <div>
          {/* Sync Now Form */}
          <div className="bg-white rounded-lg shadow p-6 mb-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Sync Now</h3>
            ...
            <form onSubmit={handleSync} className="flex items-end gap-4">
              ...
              <button
                type="submit"
                disabled={syncing}
                className="flex items-center gap-2 bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700 text-sm disabled:opacity-50 disabled:cursor-not-allowed"
              >
